...
@bot.message_handler(func=lambda message: get_cond(message.from_user.id) == 'Решение')
...
@bot.message_handler(func=lambda message: get_cond(message.from_user.id) == 'Поиск'
